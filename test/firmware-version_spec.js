...
const firmwareVersionNode = require('../src/firmware-version/firmware-version');
const eWeLinkConnect = require('../src/utils/ewelink-connect');

describe('Firmware Version Node', () => {
  ...
  it('should be loaded', done => {
    const flow = [
      ...
      { id: 'n2', type: 'ewelink-firmware-version', auth: 'n1', deviceId: '12345', name: 'Device 123' }
    ];
    helper.load([credentialsNode, firmwareVersionNode], flow, () => {
  ...
  it('should return the result of the call', done => {
    const connection = { getFirmwareVersion() { } };
    
    const methodStub = sinon.stub(connection, 'getFirmwareVersion')
    ...
    const flow = [
      { id: 'n1', type: 'ewelink-credentials' },
      { id: 'n2', type: 'ewelink-firmware-version', auth: 'n1', deviceId: '12345', wires: [['n4']] },
